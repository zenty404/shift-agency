  ...
  return (
    <div className="flex flex-col items-center gap-5">
      ...
      <div
        ...
        style={{
          border: "1px solid rgba(77, 182, 249, 0.18)",
          background: "rgba(77, 182, 249, 0.03)",
        }}
      >
        {/* Laurels + Icon */}
    ...
    >
      ...
      <div className="relative w-full py-16 sm:py-20 lg:py-24">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(77,182,249,0.06) 0%, transparent 70%)",
          }}
        />
        <div
          ref={observeStats}
